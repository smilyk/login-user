...
//@FixMethodOrder(MethodSorters.NAME_ASCENDING) заставляет тесты бежать в том порядке, в котором мы укажем...
//первый тест =а, второй тест b ...
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
class UsersWebServiceEndpointTest {



	private final String CONTEXT_PATH="/users-service";
