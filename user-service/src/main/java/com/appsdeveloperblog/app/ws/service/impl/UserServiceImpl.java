...
public class UserServiceImpl implements UserService {
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		if (userEntity == null)
			throw new UsernameNotFoundException(email);
		// if getEmailVerificationStatus() - логин запрещен
	...
	/**
	 * метод для того? что бы при логине проверять пользователя
	 *
	 * @param page - какую страницу отдать
	 * @param limit - сколько результатов на странице
	 *              localhost:8080/users?page=0&limit=2
	 * @return
	 */
	@Override
